...
def _build_persisted_result(
    ...
    if not isinstance(
        ...
        raise TypeError("Analysis result must serialise " "to a dictionary")
...
def save_analysis_result(
    ...
    *,
    ...
    record = AnalysisRecord(
        ...
        result_json=(_build_persisted_result(result)),
    )
...
def count_analysis_records(
    ...
    *,
    ...
    """
    Return the number of persisted analyses visible
    through the supplied ownership filter.
    """
    statement = select(func.count(AnalysisRecord.id))

    if owner_user_id is not None:
        statement = statement.where(AnalysisRecord.owner_user_id == owner_user_id)
