...
def test_parses_failed_login() -> None:
    line = "2026-08-01T12:00:00 " "Failed password for admin from 192.168.1.5"
...
def test_parses_successful_login() -> None:
    line = "2026-08-01T12:05:00 " "Accepted password for ryan from 192.168.1.10"
...
def test_parses_invalid_user_login() -> None:
    line = (
        "2026-08-01T12:00:00 " "Failed password for invalid user test from 10.0.0.25 "
    )
    event = parse_auth_log_line(line)
...
def test_rejects_invalid_ip_addresses() -> None:
    line = "2026-08-01T12:00:00 " "Failed password for admin from not an IP"
