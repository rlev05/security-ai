...
PASSWORD = "Dashboard-Test-Password-123!"
...
def test_user_can_login_to_dashboard(
    ...
    username, _ = register_user(client)
    ...
    assert "security_ai_session" in response.cookies
...
def test_dashboard_displays_authenticated_user(
    ...
    assert "Recent Analyses" in response.text
